...
public class M2_PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        _joystick.gameObject.SetActive(M2_CheckPlatform.isAndroid || M2_CheckPlatform.isIos);
        attackButton.SetActive(M2_CheckPlatform.isAndroid || M2_CheckPlatform.isMac);
    }
